...
| PR7 | `windows/07-sqlite-providers` | Antigravity and OpenCode SQLite readers and fixtures | Pending |
| PR8 | `windows/08-windows-runtime` | Windows core runtime/state transport boundary | Pending |
| PR9 | `windows/09-windows-tray-ui` | Tray, usage, settings, history, diagnostics | Pending |
| PR10 | `windows/10-windows-services` | Toasts, launch-at-login, updates, basic overlay | Pending |
| PR11 | `windows/11-companion-overlay` | Pet overlay, monitors, click-through, accessibility | Pending |
| PR12 | `windows/12-packaging-ci` | Windows installer, CI, artifacts, release docs | Pending |
| PR13 | `windows/13-integration` | Final integration, macOS regression, Windows hardware validation | Pending |
