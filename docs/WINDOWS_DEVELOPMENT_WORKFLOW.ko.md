...
| 1 | Provider 선택 UI | `codex/windows-provider-selection-ui` / #77 | 병합 | SEL-01/02/03 실행 |
...
- 2026-08-21: #75에서 provider 선택 회귀 테스트를, #76에서 공통 원자적
  새로고침·기록 FIFO를 병합했습니다. Native 상태 머신과 packaged Windows CI를 통과한
  provider 선택 UI PR #77도 병합했으며 SEL-01, SEL-02, SEL-03은 실기기 조건으로
  남겨 둡니다.
