...
| Tokeni 펫 | 성장 단계, 종류, 등급, 오늘 에너지, 친밀도, 행동과 선택형 화면 오버레이 |
| 도감·보상 | 1세대 5종·60개 외형, 출석, 별조각과 진화·미발견 보장 |
...
| 5 | 에이전트를 사용하고 펫 성장 및 도감의 출석 보상을 확인하고, 필요하면 화면 위 펫 활성화 |
...
| 별조각·출석 날짜·지급 완료 식별자 | 계정 비밀정보와 서버 텔레메트리 |
